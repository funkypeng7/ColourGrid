...
std::vector<std::vector<int>> EASY1 {{1, 1, 2, 2, 4, 3, 4}, {2, 1, 2, 2, 1, 3, 1}, {3, 1, 3, 2, 3, 4, 3}, {4, 0, 2, 2, 5, 2, 6}, {5, 0, 2, 5, 4, 5, 5}, {6, 0, 2, 4, 1, 4, 2}, {7, 0, 3, 7, 3, 7, 5}, {8, 1, 2, 6, 2, 7, 2}, {9, 1, 3, 5, 6, 7, 6}, {10, 1, 2, 5, 1, 6, 1}, {11, 1, 2, 4, 1, 6, 1}};
